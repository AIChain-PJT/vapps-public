...
export type VappsEventPhoneOnPutActiveParkSlots = {
    id: string
    activeParkSlots: number[]
}
export type VappsEventPhoneOnPushActiveParkSlot = {
    id: string
    slot: number
}
export type VappsEventPhoneOnDeleteActiveParkSlot = {
    id: string
    slot: number
}
export type VappsEventPhoneOnParkedUp = {
    id: string
    slot: number
}
