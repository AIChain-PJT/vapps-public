...
```
#### ◉ Vapps.putCustomCallingMaskHtml (x, y, html)
**概要:**
```
...
**Interface:**
```
Vapps.putCustomCallingMaskHtml (x: VappsPhoneLowerX, y: VappsPhoneLowerY, html: string)
```
#### ◉ Vapps.putActiveParkSlots (x, y, activeParkSlots)
**概要:**
```
...
**Interface:**
```
Vapps.putActiveParkSlots (x: VappsPhoneLowerX, y: VappsPhoneLowerY, activeParkSlots: number[])
```
#### ◉ Vapps.pushActiveParkSlot (x, y, slot)
**概要:**
```
...
**Interface:**
```
Vapps.pushActiveParkSlot (x: VappsPhoneLowerX, y: VappsPhoneLowerY, slot: number)
```
#### ◉ Vapps.delActiveParkSlot (x, y, slot)
**概要:**
```
...
**Interface:**
```
Vapps.delActiveParkSlot (x: VappsPhoneLowerX, y: VappsPhoneLowerY, slot: number)
```
